...
def refine_eclipse_widths(phases, fluxes, sigmas, pos1, pos2, width1, width2):
    ...
    try:
        ...
        print('Eclipse width refinement failed.')
...
def compute_eclipse_params(phases, fluxes, sigmas, fit_result=None, diagnose=False):
    ...
    #         print('Poor two-Gaussian fit. Results potentially unreliable!')
...
def teffratio_from_geometry(pdepth, sdepth):
    return None


def rsum_rratio_from_geometry(sep, pwidth, swidth, period):
    return None
